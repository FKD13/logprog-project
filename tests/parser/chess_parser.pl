...
'_parse_metadata'(Meta, Color, Str) :-
    string_codes(Str, Codes),
    chess_parser:parse_metadata(Meta, Color, Codes, []).

test(parse_metadata) :-
    '_parse_metadata'(m(no , no , no , no), b, " [  ]"),
    '_parse_metadata'(m(yes, no , no , no), b, " [♛ ]"),
    '_parse_metadata'(m(no , yes, no , no), b, " [ ♚]"),
    '_parse_metadata'(m(yes, yes, no , no), b, " [♛♚]"),
    '_parse_metadata'(m(no , no , yes, no), b, " [  ]☚"),
    '_parse_metadata'(m(yes, no , yes, no), b, " [♛ ]☚"),
    '_parse_metadata'(m(no , yes, yes, no), b, " [ ♚]☚"),
    '_parse_metadata'(m(yes, yes, yes, no), b, " [♛♚]☚"),
    '_parse_metadata'(m(no , no , no , no), w, " [  ]"),
    '_parse_metadata'(m(yes, no , no , no), w, " [♕ ]"),
    '_parse_metadata'(m(no , yes, no , no), w, " [ ♔]"),
    '_parse_metadata'(m(yes, yes, no , no), w, " [♕♔]"),
    '_parse_metadata'(m(no , no , yes, no), w, " [  ]☚"),
    '_parse_metadata'(m(yes, no , yes, no), w, " [♕ ]☚"),
    '_parse_metadata'(m(no , yes, yes, no), w, " [ ♔]☚"),
    '_parse_metadata'(m(yes, yes, yes, no), w, " [♕♔]☚"),
    '_parse_metadata'(m(no , no , no , 2/5), b, " [  e2]"),
    '_parse_metadata'(m(yes, no , no , 2/5), b, " [♛ e2]"),
    '_parse_metadata'(m(no , yes, no , 2/5), b, " [ ♚e2]"),
    '_parse_metadata'(m(yes, yes, no , 2/5), b, " [♛♚e2]"),
    '_parse_metadata'(m(no , no , yes, 2/5), b, " [  e2]☚"),
    '_parse_metadata'(m(yes, no , yes, 2/5), b, " [♛ e2]☚"),
    '_parse_metadata'(m(no , yes, yes, 2/5), b, " [ ♚e2]☚"),
    '_parse_metadata'(m(yes, yes, yes, 2/5), b, " [♛♚e2]☚"),
    '_parse_metadata'(m(no , no , no , 2/5), w, " [  e2]"),
    '_parse_metadata'(m(yes, no , no , 2/5), w, " [♕ e2]"),
    '_parse_metadata'(m(no , yes, no , 2/5), w, " [ ♔e2]"),
    '_parse_metadata'(m(yes, yes, no , 2/5), w, " [♕♔e2]"),
    '_parse_metadata'(m(no , no , yes, 2/5), w, " [  e2]☚"),
    '_parse_metadata'(m(yes, no , yes, 2/5), w, " [♕ e2]☚"),
    '_parse_metadata'(m(no , yes, yes, 2/5), w, " [ ♔e2]☚"),
    '_parse_metadata'(m(yes, yes, yes, 2/5), w, " [♕♔e2]☚").
